...
urlpatterns = [
    ...
    path('autocomplete/scsm', ajax_autocomplete_view, name="ajax-worldbank-scsm-autocomplete"),
    path('autocomplete/scm', ajax_autocomplete_scm_view, name='ajax-worldbank-scm-autocomplete'),
    path('autocomplete/scmm', ajax_autocomplete_view, name='ajax-worldbank-scmm-autocomplete')
]