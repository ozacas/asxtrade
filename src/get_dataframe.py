...
if __name__ == "__main__":
	args = argparse.ArgumentParser(description="Fetch the specified dataframe by tag and save to disk")
	...
	args.add_argument('--format', help="One of CSV, Excel or Parquet [CSV]", type=str, default="CSV")
